                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[1fr_3fr] gap-14 mb-10 items-start">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-1">
                                {[...Array(5)].map((_, i) => (
                                    <svg key={i} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-3 h-3 text-[#666666]">
                        ...
                        <div className="flex flex-row  md:flex-row lg:flex-row gap-12 items-start">
                            ...
                            <div className=" max-w-3xl">
                                ...
                                <p className="text-xl lg:text-4xl font-serif text-[#333333] leading-snug">
                                    {activeReview.quote}
                                </p>
