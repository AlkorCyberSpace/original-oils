...
export default function GallerySection2() {
  return (
    ...
    <section id="gallery" className="bg-white px-4 sm:px-4 md:px-8 ">
      ...
      <div className="max-w-7xl mx-auto mb-10  grid grid-cols-1  md:grid-cols-3 gap-1 md:gap-8 ">
        <div className="md:col-span-2">
          ...
          <h2 className="font-playfair text-xl md:text-5xl font-medium text-[#333333] tracking-wide leading-tight">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-3 gap-2">
        {images.map((src, i) => (
          <div
            key={i}
