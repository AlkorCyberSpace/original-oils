...
export default async function BlogDetailPage({ params }) {
  ...
  return (
    ...
    <section className="bg-white pb-16 ">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 md:px-4 sm:max-w-4xl md:max-w-7xl">
        <Link
          href="/blog"
        ...
        <div className="relative max-w-5xl h-107.5 rounded-2xl overflow-hidden mx-auto">
          ...
          <Image
            ...
            alt={blog.title}
            fill
            className={`object-cover ${blog.slug === "my-journey-with-hair-fall-after-delivery"
                ? "object-center"
